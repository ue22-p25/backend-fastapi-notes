...
<TableOfContentsItem topic='step 02a -  a table to store notes' label='02a a table to store notes' tooltip='changes in ./main.py'>
...
<TableOfContentsItem topic='step 02b -  POST /api/notes to create notes' label='02b POST /api/notes to create notes' tooltip='changes in ./main.py'>
...
<TableOfContentsItem topic='step 02c -  GET /api/notes endpoint' label='02c GET /api/notes endpoint' tooltip='changes in ./main.py'>
...
<TableOfContentsItem topic='step 02d -  GET /api/notes/id endpoint' label='02d GET /api/notes/id endpoint' tooltip='changes in ./main.py'>
